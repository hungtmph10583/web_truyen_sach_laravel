...
@section('subheader__title', 'Add New Chapter')
@section('content')
<div class="m-content">
    <!--Begin::Section-->
    <div class="m-portlet">
        ...
        @csrf
            <div class="m-portlet__body">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        <select class="form-control m-select2 m-select2-general" name="c_story_id">
                            ...
                            @foreach($stories as $story)
                                <option value="{{$story->id}}" {{ old('c_story_id') == $story->id ? 'selected' : '' }}>{{$story->s_name}}</option>
                            @endforeach
                        </select>
                        @error('c_story_id')
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        <input type="text" class="form-control m-input" name="c_name" value="{{ old('c_name') }}" placeholder="Enter chapter name">
                        @error('c_name')
                            <span class="form__help text-danger mt-2">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <!-- <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <textarea name="c_content" class="form-control" data-provide="markdown" rows="10">{{ old('c_content') }}</textarea>
                        @error('c_content')
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        <textarea name="c_content" class="summernote" id="m_summernote_1">{{ old('c_content') }}</textarea>
                        @error('c_content')
                            <span class="form__help text-danger mt-2">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="m-form__actions m-form__actions">
                    <div class="row">
                        <div class="col-lg-9 ml-lg-auto">
                            <button type="submit" class="btn btn-brand">Save New Chapter</button>
