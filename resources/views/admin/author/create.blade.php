                ...
                <form method="POST" action="" class="m-form m-form--fit m-form--label-align-right">
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group">
                            ...
                            <input type="text" class="form-control m-input m-input--square mb-1" id="a_name" name="a_name" placeholder="Enter a author name" value="{{ old('a_name') }}">
                            @error('a_name')
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="m-radio-inline">
                                <label class="m-radio m-radio--solid">
                                    <input type="radio" name="a_status" checked value="1"> Active
                                    <span></span>
                                </label>
                                <label class="m-radio m-radio--solid">
                                    <input type="radio" name="a_status" value="0"> Inactive
                                    <span></span>
                                </label>
                            </div>
                            @error('a_status')
